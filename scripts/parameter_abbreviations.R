...
GLKN_WQ_abbreviations <- data.frame(
  rbind(
    ...
    c('Chlorophyll a, free of pheophytin', 'ppb', 'ChlA_ppb'),
    ...
    c('Depth, Secchi Disk Depth', 'm', 'SecchiDepth_m'),
...
usethis::use_data(GLKN_WQ_abbreviations, active_sites, internal = T, overwrite = T)
